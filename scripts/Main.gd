...
func _ready() -> void:
    ...
    # Centered top
    _boss_hp_bar.position = Vector2(30, 80) # Adjusted manually or centered? Screen width is likely 360 based on player pos 180.
    # 360 / 2 = 180. Bar width 300 / 2 = 150. 180 - 150 = 30.
