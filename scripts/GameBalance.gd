...
@export var striker_interval: float = 0.08
@export var striker_crit_chance: float = 0.2
@export var striker_crit_mult: float = 2.0
...
@export var enemy_damage_exponent: float = 1.05
...
@export var boss_hp_exponent: float = 1.2
@export var boss_damage_exponent: float = 1.05
